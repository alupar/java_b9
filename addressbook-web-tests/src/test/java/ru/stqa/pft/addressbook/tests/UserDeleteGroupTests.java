...
public class UserDeleteGroupTests extends TestBase {
  ...
  public void ensurePreconditions(){
    if(app.db().users().size() == 0){
      app.user().create(new UserData().withFirstname("Ivan").withLastname("Ivan2").withNickname("Ivan3").withCompany("Home").withAddress("Moscow")
              .withMobile("89078922456").withHomePhone("89078922457").withWorkPhone("89078922458")
