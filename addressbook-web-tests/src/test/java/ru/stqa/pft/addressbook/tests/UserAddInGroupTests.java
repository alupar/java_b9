...
public class UserAddInGroupTests extends TestBase {
  ...
  public void ensurePreconditions(){
    ...
    if(app.db().users().size() == 0){
      app.user().create(new UserData().withFirstname("Ivan").withLastname("Ivan2").withNickname("Ivan3").withCompany("HomeWork").withAddress("Abakan")
              .withMobile("89078922450").withHomePhone("89078922451").withWorkPhone("89078922452")
    ...
    if(groupToAdd==null){
      UserData newuser = new UserData().withFirstname("Ivan7").withLastname("Ivan8").withNickname("Ivan9").withCompany("Company").withAddress("Omsk")
              .withMobile("89078922455").withHomePhone("89078922454").withWorkPhone("89078922453")
              .withEmail("w@ww.ww").withEmail2("e@e.e").withEmail3("q@q.q");
